    ...
    <div className="p-4 space-y-4">
          ...
          <div className="flex justify-between items-center py-2">
            ...
            {isEditing ? (
              <div className="flex items-center gap-2">
                ...
                <Button size="icon" className="h-8 w-8" onClick={handleSaveLimit}><Save className="h-4 w-4" /></Button>
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          ...
          <Button className="w-full mt-3" onClick={handleScheduleService}>Schedule Immediate Service</Button>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          <Button variant="outline" className="w-full" onClick={() => toast({title: "Contacting Support", description: "Email us at support@aquatrack.com"})}>Contact Support</Button>
